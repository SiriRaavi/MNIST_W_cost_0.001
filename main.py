...
data_dir = './data/mnist_10_as_2/train_data/'
...
def mann_train_cost():
    ...
    cost = T.mean(T.nnet.categorical_crossentropy(output_var_flatten, target_var.flatten())) + (0.001 * l1(params[-2]))
